export const homeStrings = {
  ...
  featureWeeklyReportTitle: 'أسبوعك مع ربنا',
  featureWeeklyReportSubtitle: 'ملخص خلوتك وقراءتك وصلواتك هذا الأسبوع',
  ...
  dailyVerseEyebrow: 'آية اليوم',
  dailyVerseTitle: 'كلمة تشجعك النهارده',
  dailyVerseShare: 'شارك الآية كصورة',
  dailyVerseShareTitle: 'آية اليوم',
  dailyVerseShareErrorTitle: 'تعذّرت المشاركة',
  dailyVerseShareErrorMessage: 'حاول مرة أخرى بعد لحظات.',
  answerNow: 'جاوب الآن',
  editAnswer: 'تعديل الإجابة',
  todayReadingEyebrow: 'قراءتك النهارده',
  todayReadingTitle: (reading: string) => `النهارده هتقرأ في ${reading}`,
  todayReadingSubtitle: 'بناءً على آخر خلوة أكملتها',
  todayReadingFirstTime: 'ابدأ رحلتك من أول السفر',
  ...
  planTodayEyebrow: 'خطة اليوم',
  planTodayDay: (day: number) => `اليوم ${day}`,
  planTodayQuestion: 'قرأت جزء خطة النهارده؟',
  planTodayApply: 'سجّلها بضغطة',
  planTodayApplied: 'تمت إضافتها ✓',
  ...
  quickActions: {
    ...
    bibleReader: 'قراءة الكتاب المقدس',
